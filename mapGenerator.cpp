...
void mapGenerator::drawMap(ShaderProgram* sp, GLuint tex0)
{
	...
	glVertexAttribPointer(sp->a("vertex"), 4, GL_FLOAT, false, 0, mapVertices); //Wska¿ tablicê z danymi dla atrybutu vertex

	glEnableVertexAttribArray(sp->a("color"));  //W³¹cz przesy³anie danych do atrybutu color
	glVertexAttribPointer(sp->a("color"), 4, GL_FLOAT, false, 0, mapColors); //Wska¿ tablicê z danymi dla atrybutu color

	glEnableVertexAttribArray(sp->a("normal"));  //W³¹cz przesy³anie danych do atrybutu normal
	glVertexAttribPointer(sp->a("normal"), 4, GL_FLOAT, false, 0, mapNormals); //Wska¿ tablicê z danymi dla atrybutu normal
